...
1. Lawyer verification and legal aid matching.
2. Document repository and OCR.
3. RTI generation and notifications.
4. Admin dashboard, audit logs, metrics, and hardening.
